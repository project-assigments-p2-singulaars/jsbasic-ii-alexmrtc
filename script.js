...
const result = console.log(weather === "soleado" ? "Me vestiré con un vestido" : "Me vestiré con pantalón"); //Escribe tu código aquí;
...
for (const programmer in programmers) {
  console.log(
    `${programmer}: ${programmers[programmer].name} ${programmers[programmer].lastname}, su aporte fue ${programmers[programmer].knowledge}`
  );
}
...
function calcularAreaRectangulo(ancho, alto) {
    ...
    console.log(`Area de rectangulo: ${areaRectangulo}`)
}

calcularAreaRectangulo(2, 3);
calcularAreaRectangulo(6, 32);
calcularAreaRectangulo(12, 15);
calcularAreaRectangulo(42, 15);